    ...
    <div>
        ...
        <div className="pt-6">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
                ...
                <button type="submit" className="mt-10 w-full bg-gray-900 border border-transparent rounded-md py-4 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900">
                    Add to bag
                </button>
                </form>
            </div>
